...
keymap("n", "<leader>gtl", "<cmd>Gitsigns toggle_current_line_blame<CR>", "Toggle current line blame")
...
keymap("n", "<leader>gth", "<cmd>Gitsigns toggle_linehl<CR>", "Toggle line highlight")
