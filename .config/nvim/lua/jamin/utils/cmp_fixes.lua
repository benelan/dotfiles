--- Fix some issues with completion behavior and snippet expansion. Taken from:
--- https://github.com/LazyVim/LazyVim/blob/c8159b6abff959d1b029c87260edc05e8420a213/lua/lazyvim/util/cmp.lua
local M = {}
...
function M.expand(snippet)
  ...
  if not ok then
    ...
    pcall(vim.snippet.expand, fixed)
  end
