return {
  ...
  },
  {
    ...
    keys = {
      ...
      { "<leader>ghw", function() require("gitsigns").stage_hunk { vim.fn.line ".", vim.fn.line "v" } end, desc = "Stage hunk", mode = "v" },
      ...
      { "<leader>ghw", function() require("gitsigns").stage_hunk() end, desc = "Stage hunk" },
