    ...
    opts = {
      ...
      mappings = {
        issue = {
          ...
          open_in_browser = { lhs = "<leader>oo", desc = "Open in browser" },
          ...
          react_hooray = { lhs = "<leader>ort", desc = "Toggle 🎉 " },
          react_heart = { lhs = "<leader>orh", desc = "Toggle ❤️  " },
          react_eyes = { lhs = "<leader>ore", desc = "Toggle 👀 " },
          react_thumbs_up = { lhs = "<leader>orp", desc = "Toggle 👍 " },
          react_thumbs_down = { lhs = "<leader>orm", desc = "Toggle 👎 " },
          react_rocket = { lhs = "<leader>orr", desc = "Toggle 🚀 " },
          react_laugh = { lhs = "<leader>orl", desc = "Toggle 😄 " },
          react_confused = { lhs = "<leader>orc", desc = "Toggle 😕 " },
        },
        pull_request = {
          copy_url = { lhs = "<leader>oy", desc = "Copy url" },
          open_in_browser = { lhs = "<leader>oo", desc = "Open in browser" },
